!function (a) {
    ...
    b = function () {
        ...
        var a = this;
        a.listWidth = $(window).width() > 600 ? 1140 : 570, a.listHeight = a.$list.height(), a.slideWidth = a.options.vertical === !1 ? Math.ceil(a.listWidth / a.options.slidesToShow) : Math.ceil(a.listWidth)
