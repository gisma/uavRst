if (!isGeneric('fa_pc2pixcount')) {
  setGeneric('fa_pc2pixcount', function(x, ...)
    standardGeneric('fa_pc2pixcount'))
}
...
#'@return fa_pc2pixcount basically returns a  DSM
#'
#'
#'@export fa_pc2pixcount
#'@examples
#'\dontrun{
#' # create a DSM based on a uav point cloud 
#'  fa_pc2pixcount(lasDir =  lasDir,
...
fa_pc2pixcount <- function(lasDir = NULL,
                   gisdbase_path = NULL,
                   GRASSlocation = "tmp/",
                   projFolder = c("data/","output/","run/","las/"),
                   grid_size = "0.5", 
  ...
  if (!exists(sagaCmd)) saga <- link2GI::linkSAGA()
  # some basic checks 
